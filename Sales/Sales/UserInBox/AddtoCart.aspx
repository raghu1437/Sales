<%@ Page Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" Inherits="UserInBox_AddtoCart" Title="Welcome to addtocart" Codebehind="AddtoCart.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: center">
        <table style="width: 100px; position: static; height: 100px">
            <tr>
                <td align="center" colspan="3" rowspan="2" valign="top">
