<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="user_Equipments" Title="Welcome to Equipments" Codebehind="Equipments.aspx.cs" %>
            ...
            <td align="center" colspan="3" style="height: 22px" valign="top">
                <strong><span style="font-size: 14pt; font-family: Vardana; text-decoration: underline">
                    <asp:Label ID="Label7" runat="server" ForeColor="#00C0C0" Style="position: static"
                        Text="Available Equipments Details"></asp:Label></span></strong></td>
        </tr>
        <tr>
            <td align="right" colspan="3">
                <div style="text-align: left">
                    <table style="width: 780px; position: static; height: 6px">
                        <tr>
