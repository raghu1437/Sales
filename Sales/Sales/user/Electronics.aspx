<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="user_Electronics" Title="Welcome to Electronics" Codebehind="Electronics.aspx.cs" %>
            ...
            <td align="center" colspan="3" style="height: 22px" valign="top">
                <strong><span style="font-size: 14pt; font-family: Vardana; text-decoration: underline">
                    <asp:Label ID="Label7" runat="server" ForeColor="#00C0C0" Style="position: static"
                        Text="Available Electronics Details"></asp:Label></span></strong></td>
        </tr>
        <tr>
            <td align="right" colspan="3">
                <div style="text-align: left">
                    <table style="width: 778px; position: static; height: 6px">
                        <tr>
