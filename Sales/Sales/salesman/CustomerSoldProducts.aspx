<%@ Page Language="C#" MasterPageFile="~/salesman.master" AutoEventWireup="true" Inherits="Admin_CustomerSoldProducts" Title="Untitled Page" Codebehind="CustomerSoldProducts.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="0" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging" Style="position: static" Width="515px">
        <Columns>
