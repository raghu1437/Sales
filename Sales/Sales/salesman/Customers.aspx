<%@ Page Language="C#" MasterPageFile="~/salesman.master" AutoEventWireup="true" Inherits="Admin_Customers" Title="Registerd customers details" Codebehind="Customers.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        PageSize="6" Style="position: static" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
